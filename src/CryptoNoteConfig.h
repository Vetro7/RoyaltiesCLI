...
const uint64_t MULTIPLIER_FACTOR                             = 10; //early depositor multiplier
const uint32_t END_MULTIPLIER_BLOCK                          = 10000; //block at which the multiplier ceases to be applied
